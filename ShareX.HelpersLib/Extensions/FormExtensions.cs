...
public static class FormExtensions
{
    ...
    {
        Font font = fontSize > 0 ? new Font(rtb.Font.FontFamily, fontSize, fontStyle) : new Font(rtb.Font, fontStyle);
    ...
    public static void AddContextMenu(this RichTextBox rtb)
    {
        if (rtb.ContextMenuStrip == null)
        {
            ...
            ToolStripMenuItem tsmiUndo = new(Resources.Extensions_AddContextMenu_Undo);
            tsmiUndo.Click += (sender, e) => rtb.Undo();
            cms.Items.Add(tsmiUndo);

            ToolStripMenuItem tsmiRedo = new(Resources.Extensions_AddContextMenu_Redo);
            tsmiRedo.Click += (sender, e) => rtb.Redo();
            cms.Items.Add(tsmiRedo);

            cms.Items.Add(new ToolStripSeparator());

            ToolStripMenuItem tsmiCut = new(Resources.Extensions_AddContextMenu_Cut);
            tsmiCut.Click += (sender, e) => rtb.Cut();
            cms.Items.Add(tsmiCut);

            ToolStripMenuItem tsmiCopy = new(Resources.Extensions_AddContextMenu_Copy);
            tsmiCopy.Click += (sender, e) => rtb.Copy();
            cms.Items.Add(tsmiCopy);

            ToolStripMenuItem tsmiPaste = new(Resources.Extensions_AddContextMenu_Paste);
            tsmiPaste.Click += (sender, e) => rtb.Paste();
            cms.Items.Add(tsmiPaste);

            ToolStripMenuItem tsmiDelete = new(Resources.Extensions_AddContextMenu_Delete);
            tsmiDelete.Click += (sender, e) => rtb.SelectedText = "";
            cms.Items.Add(tsmiDelete);

            cms.Items.Add(new ToolStripSeparator());

            ToolStripMenuItem tsmiSelectAll = new(Resources.Extensions_AddContextMenu_SelectAll);
        ...
        if (!lv.OwnerDraw)
        {
            ...
            lv.DrawColumnHeader += (sender, e) =>
            {
                if (ShareXResources.UseCustomTheme)
                {
                    ...
                    {
                        using Pen pen = new(ShareXResources.Theme.SeparatorDarkColor);
                        using Pen pen2 = new(ShareXResources.Theme.SeparatorLightColor);
