...
public static class GraphicsPathExtensions
{
    ...
    {
        PointF p1 = new(rect.X + rect.Width / 2.0f, rect.Y);
        PointF p2 = new(rect.X + rect.Width, rect.Y + rect.Height / 2.0f);
        PointF p3 = new(rect.X + rect.Width / 2.0f, rect.Y + rect.Height);
        PointF p4 = new(rect.X, rect.Y + rect.Height / 2.0f);

        graphicsPath.AddPolygon([p1, p2, p3, p4]);
    }
    ...
    public static void WindingModeOutline(this GraphicsPath graphicsPath)
    {
        ...
        HandleRef path = new(graphicsPath, handle);
        _ = NativeMethods.GdipWindingModeOutline(path, IntPtr.Zero, 0.25F);
    }
}