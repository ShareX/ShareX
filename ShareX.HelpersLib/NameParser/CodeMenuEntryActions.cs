...
public class CodeMenuEntryActions : CodeMenuEntry
{
    ...
    public static readonly CodeMenuEntryActions input = new("input", Resources.ActionsCodeMenuEntry_FilePath_File_path);
    public static readonly CodeMenuEntryActions output = new("output", Resources.ActionsCodeMenuEntry_OutputFilePath_File_path_without_extension____Output_file_name_extension_);
