...
public class Translator
{
    ...
    public string BinaryText => Binary != null && Binary.Length > 0 ? Binary.Join() : null;

    // http://en.wikipedia.org/wiki/Hexadecimal
    public string[] Hexadecimal { get; private set; }

    public string HexadecimalText => Hexadecimal != null && Hexadecimal.Length > 0 ? Hexadecimal.Join().ToUpperInvariant() : null;

    // http://en.wikipedia.org/wiki/ASCII
    public byte[] ASCII { get; private set; }

    public string ASCIIText => ASCII != null && ASCII.Length > 0 ? ASCII.Join() : null;
