...
public class ShareXTheme
{
    ...
    public static ShareXTheme DarkTheme => new()
    {
        Name = "Dark",
    ...
    public static ShareXTheme LightTheme => new()
    {
        Name = "Light",
    ...
    public static ShareXTheme NightTheme => new()
    {
        Name = "Night",
    ...
    public static ShareXTheme NordDarkTheme => new()
    {
        Name = "Nord Dark",
    ...
    // https://www.nordtheme.com
    public static ShareXTheme NordLightTheme => new()
    {
        Name = "Nord Light",
    ...
    public static ShareXTheme DraculaTheme => new()
    {
        Name = "Dracula",
