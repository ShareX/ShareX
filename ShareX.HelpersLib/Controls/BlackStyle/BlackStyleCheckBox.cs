...
public class BlackStyleCheckBox : Control
{
    ...
    {
        Rectangle rect = new(checkBoxSize + SpaceAfterCheckBox, 0, ClientRectangle.Width - checkBoxSize + SpaceAfterCheckBox, ClientRectangle.Height);
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        innerBorderBrush?.Dispose();
        innerBorderPen?.Dispose();
        innerBorderCheckedBrush?.Dispose();
        innerBorderCheckedPen?.Dispose();
        borderPen?.Dispose();
