...
public class ToolStripRadioButtonMenuItem : ToolStripMenuItem
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        Point imageLocation = new(ContentRectangle.Location.X + 4, ContentRectangle.Location.Y + offset);
        ...
        if (Checked && RadioButtonRenderer.IsBackgroundPartiallyTransparent(buttonState))
        {
            ...
            glyphSize.Height--;
            glyphSize.Width--;
            Rectangle backgroundRectangle = new(imageLocation, glyphSize);
    ...
    public override bool Enabled
    {
        get
        {
            ...
            return !DesignMode && OwnerItem is ToolStripMenuItem ownerMenuItem && ownerMenuItem.CheckOnClick
