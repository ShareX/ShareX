...
namespace ShareX.HelpersLib.Random;
...
public static class RandomCrypto
{
    ...
    {
        return maxValue < 0 ? throw new ArgumentOutOfRangeException(nameof(maxValue)) : Next(0, maxValue);
    }
    ...
    public static T Pick<T>(params T[] array)
    {
        return array == null
            ...
            : array.Length == 0 ? throw new ArgumentException(null, nameof(array)) : array[Next(array.Length - 1)];
    }
    ...
    public static T Pick<T>(List<T> list)
    {
        return list == null
            ...
            : list.Count == 0 ? throw new ArgumentException(null, nameof(list)) : list[Next(list.Count - 1)];
    }
