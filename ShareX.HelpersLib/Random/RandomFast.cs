...
public static class RandomFast
{
    ...
    public static T Pick<T>(params T[] array)
    {
        return array == null
            ...
            : array.Length == 0 ? throw new ArgumentException(nameof(array)) : array[Next(array.Length - 1)];
    }
    ...
    public static T Pick<T>(List<T> list)
    {
        return list == null
            ...
            : list.Count == 0 ? throw new ArgumentException(nameof(list)) : list[Next(list.Count - 1)];
    }
