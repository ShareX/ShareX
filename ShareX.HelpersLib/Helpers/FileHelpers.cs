...
public static class FileHelpers
{
    public static readonly string[]
        ImageFileExtensions = ["jpg", "jpeg", "png", "gif", "bmp", "ico", "tif", "tiff"],

        TextFileExtensions = [ "txt", "log", "nfo", "c", "cpp", "cc", "cxx", "h", "hpp", "hxx", "cs", "vb",
        "html", "htm", "xhtml", "xht", "xml", "css", "js", "php", "bat", "java", "lua", "py", "pl", "cfg", "ini", "dart", "go", "gohtml" ],

        VideoFileExtensions = [ "mp4", "webm", "mkv", "avi", "vob", "ogv", "ogg", "mov", "qt", "wmv", "m4p",
    ...
    {
        return IsImageFile(filePath) ? EDataType.Image : IsTextFile(filePath) ? EDataType.Text : EDataType.File;
    }
    ...
    public static string GetPathRoot(string path)
    {
        ...
        return separator > 0 ? path.Substring(0, separator + 2) : "";
    }
    ...
    public static string SanitizePath(string path, string replaceWith = "")
    {
        ...
        char[] invalidChars = [.. Path.GetInvalidFileNameChars().Except([Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar])];
    ...
    public static string GetFileSizeReadable(string filePath, bool binaryUnits = false)
    {
        ...
        return fileSize >= 0 ? fileSize.ToSizeString(binaryUnits) : "";
    }
    ...
    {
        HashSet<string> allowedExtensions = new(extensions, StringComparer.OrdinalIgnoreCase);
