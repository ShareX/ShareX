...
internal class ClipboardHelpersEx
{
    ...
    public static byte[] ConvertToDib(Image image)
    {
        ...
        using (Bitmap bm32b = new(image.Width, image.Height, PixelFormat.Format32bppPArgb))
        {
    ...
    public static Bitmap DIBV5ToBitmap(byte[] data)
    {
        ...
        IntPtr scan0 = new(handle.AddrOfPinnedObject().ToInt64() + offset);
        Bitmap bitmap = new(bmi.bV5Width, bmi.bV5Height, stride, PixelFormat.Format32bppPArgb, scan0);
        handle.Free();
        return bitmap;
    }
}