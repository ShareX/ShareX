...
public static class MathHelpers
{
    ...
    {
        return num.CompareTo(min) > 0 ? min : num;
    }
    ...
    {
        return num.CompareTo(min) <= 0 ? min : num.CompareTo(max) >= 0 ? max : num;
    }
    ...
    {
        return num.CompareTo(min) >= 0 && num.CompareTo(max) <= 0 ? num : defaultValue;
    }
