namespace ShareX.HelpersLib
{
    partial class ColorPickerForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.nudKey.Enter += new System.EventHandler(this.nudKey_Enter);
			// 
			// nudYellow
			// 
			...
			this.nudYellow.Enter += new System.EventHandler(this.nudYellow_Enter);
			// 
			// nudMagenta
			// 
			...
			this.nudMagenta.Enter += new System.EventHandler(this.nudMagenta_Enter);
			// 
			// nudCyan
			// 
			...
			this.nudCyan.Enter += new System.EventHandler(this.nudCyan_Enter);
			// 
			// lblKey
			// 
			...
			this.nudBlue.Enter += new System.EventHandler(this.nudBlue_Enter);
			// 
			// nudGreen
			// 
			...
			this.nudGreen.Enter += new System.EventHandler(this.nudGreen_Enter);
			// 
			// nudRed
			// 
			...
			this.nudRed.Enter += new System.EventHandler(this.nudRed_Enter);
			// 
			// nudBrightness
			// 
			...
			this.nudBrightness.Enter += new System.EventHandler(this.nudBrightness_Enter);
			// 
			// nudSaturation
			// 
			...
			this.nudSaturation.Enter += new System.EventHandler(this.nudSaturation_Enter);
			// 
			// nudHue
			// 
			...
			this.nudHue.Enter += new System.EventHandler(this.nudHue_Enter);
			// 
			// rbBlue
			// 
			...
			this.rbHue.UseVisualStyleBackColor = false;
			...
			this.nudAlpha.Enter += new System.EventHandler(this.nudAlpha_Enter);
			// 
			// lblAlpha
			// 
			...
			// panel1
			// 
			this.panel1.Controls.Add(this.rbBrightness);
			this.panel1.Controls.Add(this.rbBlue);
			this.panel1.Controls.Add(this.rbSaturation);
			this.panel1.Controls.Add(this.rbGreen);
			this.panel1.Controls.Add(this.rbHue);
