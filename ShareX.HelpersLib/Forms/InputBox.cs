...
public class InputBox : Form
{
    ...
    {
        using InputBox form = new(title, inputText, okText, cancelText);
    ...
    {
        System.ComponentModel.ComponentResourceManager resources = new(typeof(InputBox));
        btnOK = new Button();
        ...
        TopMost = true;
        Shown += new EventHandler(InputBox_Shown);
        ResumeLayout(false);
        PerformLayout();
    }
