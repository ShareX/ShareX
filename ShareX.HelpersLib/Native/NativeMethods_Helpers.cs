...
public static partial class NativeMethods
{
    ...
    {
        return IntPtr.Size > 4 ? GetClassLongPtr(hWnd, nIndex) : new IntPtr(GetClassLong(hWnd, nIndex));
    }
    ...
    public static void RestoreWindow(IntPtr handle)
    {
        ...
        {
            wp.showCmd = wp.flags == (int)WindowPlacementFlags.WPF_RESTORETOMAXIMIZED ? WindowShowStyle.ShowMaximized : WindowShowStyle.Restore;
    ...
    public static Icon GetJumboFileIcon(string filePath, bool jumboSize = true)
    {
        ...
        Guid guil = new(NativeConstants.IID_IImageList2);
