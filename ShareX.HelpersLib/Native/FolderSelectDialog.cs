...
public class FolderSelectDialog : IDisposable
{
    ...
    {
        get => ofd.Title;
        set => ofd.Title = string.IsNullOrEmpty(value) ? Resources.FolderSelectDialog_Title_Select_a_folder : value;
    }
    ...
    public bool ShowDialog() => ShowDialog(NativeMethods.GetActiveWindow());
    ...
    public bool ShowDialog(IntPtr hWndOwner)
    {
        ...
        {
            Reflector r = new("System.Windows.Forms");
            ...
            uint options = (uint)Reflector.CallAs(typeof(FileDialog), ofd, "GetOptions");
