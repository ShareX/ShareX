...
public class DrawText : ImageEffect
{
    ...
    private FontSafe textFontSafe = new();
    ...
    public override Bitmap Apply(Bitmap bmp)
    {
        ...
        using (Font textFont = TextFont)
        {
            ...
            Size watermarkSize = new(Padding.Left + textSize.Width + Padding.Right, Padding.Top + textSize.Height + Padding.Bottom);
            Point watermarkPosition = Helpers.GetPosition(Placement, Offset, bmp.Size, watermarkSize);
            Rectangle watermarkRectangle = new(watermarkPosition, watermarkSize);
            ...
            using (GraphicsPath gp = new())
            {
                ...
                if (DrawBackground)
                {
                    ...
                    try
                    {
                        backgroundBrush = UseGradient && Gradient != null && Gradient.IsValid
