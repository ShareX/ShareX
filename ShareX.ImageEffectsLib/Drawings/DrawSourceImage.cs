...
namespace ShareX.ImageEffectsLib
{
    ...
    public class DrawSourceImage : ImageEffect
    {
        ...
        public Bitmap Apply(Bitmap bmp, Bitmap bmpSource)
        {
            ApplyWatermark(bmp, bmpSource);
            return bmp;
        }

        void ApplyWatermark(Bitmap bmp, Bitmap bmpWatermark)
        {
            if (RotateFlip != ImageRotateFlipType.None)
                bmpWatermark.RotateFlip((RotateFlipType)RotateFlip);

            Size imageSize = GetImageSize(bmp, bmpWatermark);
        ...
        private Size GetImageSize(Bitmap bmp, Bitmap bmpWatermark)
        {
            Size imageSize;
