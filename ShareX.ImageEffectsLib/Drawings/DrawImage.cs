...
public class DrawImage : ImageEffect
{
    ...
    public override Bitmap Apply(Bitmap bmp)
    {
        ...
        if (!string.IsNullOrEmpty(imageFilePath) && File.Exists(imageFilePath))
        {
            ...
            if (bmpWatermark != null)
            {
                ...
                Rectangle imageRectangle = new(imagePosition, imageSize);
                ...
                if (Tile)
                {
                    using TextureBrush brush = new(bmpWatermark, WrapMode.Tile);
    ...
    {
        return !string.IsNullOrEmpty(ImageLocation) ? FileHelpers.GetFileNameSafe(ImageLocation) : null;
    }
}