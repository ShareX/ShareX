...
#define AppParentDirectory RootDirectory + "\ShareX\bin\Debug"
...
Source: "{#AppParentDirectory}\*.pdb"; DestDir: {app}; Flags: ignoreversion
...
Source: "{#RootDirectory}\..\ShareX_Chrome\ShareX_Chrome\bin\Debug\ShareX_Chrome.exe"; DestDir: {app}; Flags: ignoreversion
