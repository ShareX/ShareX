...
internal class Program
{
    ...
    private static void UpdatePaths()
    {
        ...
        Configuration = Job.HasFlag(SetupJobs.CreateDebug)
            ? "Debug"
            : Job.HasFlag(SetupJobs.CreateSteamFolder)
                ? "Steam"
                : Job.HasFlag(SetupJobs.CreateMicrosoftStoreFolder)
                            ? "MicrosoftStore"
                            : Job.HasFlag(SetupJobs.CreateMicrosoftStoreDebugFolder) ? "MicrosoftStoreDebug" : "Release";
