...
The default Image Editor resource set contains 258 keys, with matching translations in all 27 localized cultures. Emoji catalog names and categories come directly from the embedded English catalog and are intentionally excluded from localization.
