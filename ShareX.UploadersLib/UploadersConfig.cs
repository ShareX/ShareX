...
namespace ShareX.UploadersLib
{
    public class UploadersConfig : SettingsBase<UploadersConfig>
    {
        ...
        public List<OwnCloud.OwnCloudPathFilterItem> OwnCloudPathFilters = new List<OwnCloud.OwnCloudPathFilterItem>()
        {
            ...
            new OwnCloud.OwnCloudPathFilterItem() { Path = "/Share/Text", Filter = "\\.(bat|c|cfg|cpp|cs|csv|h|hh|hpp|htm|html|ini|java|js|json|log|lua|md|php|pl|py|rb|sh|txt|vb|xml)$" },
