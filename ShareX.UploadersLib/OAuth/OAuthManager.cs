...
public static class OAuthManager
{
    ...
    {
        using SHA1 sha1 = SHA1.Create();
        using (CryptoStream cs = new(Stream.Null, sha1, CryptoStreamMode.Write))
        {
