...
namespace ShareX.UploadersLib.ImageUploaders
{
    ...
    public sealed class Chevereto : ImageUploader
    {
        ...
        {
            new CheveretoUploader("http://ultraimg.com/api/1/upload", "3374fa58c672fcaad8dab979f7687397"), // SSL redirect broken (infinite loop)
            new CheveretoUploader("https://yukle.at/3/api/1/upload", "bf3f97649acf179ac17e2b3004fa44bc"),
            new CheveretoUploader("http://img.patifile.com/api/1/upload", "8320784a9b044510e8c723fb778fe3b7"),
            new CheveretoUploader("https://boltimg.com/api/1/upload", "8dfbcb7ab9b5258a90be7cf09e361894"),
            ...
            new CheveretoUploader("https://lightpics.net/api/1/upload", "7c6238e8f24c19454315d5dc812d4b93"),
            ...
            new CheveretoUploader("https://www.upsieutoc.com/api/1/upload", "c692ca0925f8da5990e8c795602bf942"),
            new CheveretoUploader("http://www.storemypic.com/api/1/upload", "995269492c2a19902715d5cc3ed810fa"), // SSL redirects to http
            ...
            new CheveretoUploader("https://www.img-load.de/api/1/upload", "980ac733e6d272b5d7a6ee16afb753aa"),
            new CheveretoUploader("http://imgchr.com/api/1/upload", "a788873e81d83019f4807c87145ddf1f"),
            new CheveretoUploader("https://images.the-hive.fr/api/1/upload", "85c20c20105e5b741c11108498d5403b"),
