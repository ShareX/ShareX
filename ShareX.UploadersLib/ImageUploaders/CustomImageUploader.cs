...
namespace ShareX.UploadersLib.ImageUploaders
{
    public sealed class CustomImageUploader : ImageUploader
    {
        ...
        public override UploadResult Upload(Stream stream, string fileName)
        {
            ...
            UploadResult result = UploadData(stream, customUploader.GetRequestURL(), fileName, customUploader.GetFileFormName(), customUploader.GetArguments(), headers: customUploader.GetHeaders().ToNameValueCollection(), responseType: customUploader.ResponseType);
