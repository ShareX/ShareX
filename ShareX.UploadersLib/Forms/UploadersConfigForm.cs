...
public partial class UploadersConfigForm : Form
{
    ...
    private void InitializeControls()
    {
        ...
        // FTP
        cbFTPURLPathProtocol.Items.AddRange(HelpersLib.Helpers.Helpers.GetEnumDescriptions<BrowserProtocol>());
    ...
    private void LoadImageUploaderSettings()
    {
        ...
        cbImgurThumbnailType.Items.AddRange(HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<ImgurThumbnailType>());
    ...
    private void LoadTextUploaderSettings()
    {
        ...
        cbPastebinPrivacy.Items.AddRange(HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<PastebinPrivacy>());
        cbPastebinPrivacy.SelectedIndex = (int)Config.PastebinSettings.Exposure;
        cbPastebinExpiration.Items.AddRange(HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<PastebinExpiration>());
    ...
    private void LoadFileUploaderSettings()
    {
        ...
        */
        ...
        cbBoxShareAccessLevel.Items.AddRange(HelpersLib.Helpers.Helpers.GetEnumDescriptions<BoxShareAccessLevel>());
...
- You can now authenticate to Jira", Links.Website, "ShareX", APIKeys.APIKeys.JiraConsumerKey, Jira.PublicKey);
        } catch (Exception e)
        {
        ...
        if (Config.PushbulletSettings.DeviceList.Count > 0)
        {
            ...
            cbPushbulletDevices.SelectedIndex = Config.PushbulletSettings.DeviceList.IsValidIndex(Config.PushbulletSettings.SelectedDevice)
                ? Config.PushbulletSettings.SelectedDevice
                : 0;
        }
        ...
        cbAmazonS3StorageClass.Items.AddRange(HelpersLib.Helpers.Helpers.GetEnumDescriptions<AmazonS3StorageClass>());
        ...
        cbYouTubePrivacyType.Items.AddRange(HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<YouTubeVideoPrivacy>());
    ...
    {
        OAuth2Info oauth = new(APIKeys.APIKeys.ImgurClientID, APIKeys .APIKeys.ImgurClientSecret);
    ...
    {
        ImageShackUploader imageShackUploader = new(APIKeys.APIKeys.ImageShackKey, Config.ImageShackSettings);
    ...
    {
        URLHelpers.OpenURL($"https://paste.ee/account/api/authorize/{APIKeys.APIKeys.Paste_eeApplicationKey}");
    }
    ...
    {
        OAuth2Info oauth = new(APIKeys.APIKeys.GitHubID, APIKeys.APIKeys.GitHubSecret);
    ...
    {
        OAuth2Info oauth = new(APIKeys.APIKeys.DropboxConsumerKey, APIKeys.APIKeys.DropboxConsumerSecret);
    ...
    {
        OAuth2Info oauth = new(APIKeys.APIKeys.OneDriveClientID, APIKeys.APIKeys.OneDriveClientSecret);
    ...
    {
        OAuth2Info oauth = new(APIKeys.APIKeys.GoogleClientID, APIKeys   .APIKeys.GoogleClientSecret);
        IOAuth2Loopback oauthLoopback = new GoogleDrive(oauth).OAuth2;

        using (OAuthListenerForm form = new(oauthLoopback))
        {
            form.ShowDialog();
...
"ShareX - Google Drive", MessageBoxButtons.OK, MessageBoxIcon.Question);
    ...
    {
        OAuth2Info oauth = new(APIKeys.APIKeys.BoxClientID, APIKeys.APIKeys.BoxClientSecret);
    ...
    private void MegaConfigureTab(bool tryLogin)
    {
        ...
        } else
        {
            ...
            Mega mega = new(Config.MegaAuthInfos?.GetMegaApiClientAuthInfos());
    ...
    private void btnMegaLogin_Click(object sender, EventArgs e)
    {
        ...
        Config.MegaAuthInfos = megaAuthInfos != null ? new MegaAuthInfos(megaAuthInfos) : null;
    ...
    private void btnSeafileCheckAPIURL_Click(object sender, EventArgs e)
    {
        ...
        Seafile sf = new(cbSeafileAPIURL.Text, null, null);
    ...
    private void btnSeafileCheckAuthToken_Click(object sender, EventArgs e)
    {
        ...
        Seafile sf = new(cbSeafileAPIURL.Text, txtSeafileAuthToken.Text, null);
    ...
    private void btnSeafilePathValidate_Click(object sender, EventArgs e)
    {
        ...
        Seafile sf = new(cbSeafileAPIURL.Text, txtSeafileAuthToken.Text, Config.SeafileRepoID);
    ...
    {
        OAuth2Info oauth = new(APIKeys.APIKeys.BitlyClientID, APIKeys.APIKeys.BitlyClientSecret);
