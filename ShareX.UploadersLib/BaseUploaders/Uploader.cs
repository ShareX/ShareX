...
public class Uploader
{
    ...
    public static void UpdateServicePointManager()
    {
        ...
        if (HelpersLib.Helpers.Helpers.IsWindows7())
        {
            try
            {
                ...
                // Use HttpClientHandler to set the security protocol for HttpClient
        ...
        string relatedData = null)
    {
        ...
        try
        {
            ...
            byte[] bytesDataOpen = relatedData != null
    ...
    protected bool TransferData(Stream dataStream, Stream requestStream, long dataPosition = 0, long dataLength = -1)
    {
        ...
        ProgressManager progress = new(dataStream.Length, dataPosition);
    ...
    private string ProcessWebResponseText(HttpWebResponse response)
    {
        ...
        return responseInfo != null ? responseInfo.ResponseText : null;
    }
        ...
        Dictionary<string, string> customParameters = null, HttpMethod httpMethod = HttpMethod.GET)
    {
        ...
        return !string.IsNullOrEmpty(response) ? OAuthManager.GetAuthorizationURL(response, authInfo, authorizeURL) : null;
    }
    ...
    protected NameValueCollection GetAccessTokenEx(string accessTokenURL, OAuthInfo authInfo, HttpMethod httpMethod = HttpMethod.GET)
    {
        ...
        return !string.IsNullOrEmpty(response) ? OAuthManager.ParseAccessTokenResponse(response, authInfo) : null;
    }
