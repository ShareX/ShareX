...
public static class UploadersConfigValidator
{
    ...
    {
        return destination == ImageDestination.FileUploader ? true : UploaderFactory.ImageUploaderServices[destination].CheckConfig(config);
    }

    public static bool Validate(TextDestination destination, UploadersConfig config)
    {
        return destination == TextDestination.FileUploader ? true : UploaderFactory.TextUploaderServices[destination].CheckConfig(config);
    }
