...
public sealed class OneDrive : FileUploader, IOAuth2
{
    ...
    {
        string folderPath = !string.IsNullOrEmpty(folderID) ? URLHelpers.CombineURL("me/drive/items", folderID) : "me/drive/root";
        return folderPath;
    }
    ...
    private string CreateSession(string fileName)
    {
        ...
        return session != null ? session.uploadUrl : null;
    }
    ...
    public string CreateShareableLink(string id, OneDriveLinkType linkType = OneDriveLinkType.Read)
    {
        ...
        return permissionInfo != null && permissionInfo.link != null ? permissionInfo.link.webUrl : null;
    }
