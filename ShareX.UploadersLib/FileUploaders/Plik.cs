...
public sealed class Plik : FileUploader
{
    ...
    public override UploadResult Upload(Stream stream, string fileName)
    {
        ...
        UploadMetadataRequest metaDataReq = new();
        ...
        metaDataReq.Ttl = Settings.TTLUnit != 3 ? Convert.ToInt32(GetMultiplyIndex(2, Settings.TTLUnit) * Settings.TTL * 60) : -1;
    ...
    {
        UploadResult result = new(fileDataReq.Response);
