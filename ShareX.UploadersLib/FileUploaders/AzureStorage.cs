...
public sealed class AzureStorage : FileUploader
{
    ...
    public override UploadResult Upload(Stream stream, string fileName)
    {
        ...
        NameValueCollection requestHeaders = new();
    ...
    public string GenerateURL(string uploadPath, bool isRequest = false)
    {
        ...
        {
            url = !isRequest && AzureStorageContainer == "$root"
                ? $"https://{AzureStorageAccountName}.{AzureStorageEnvironment}/{uploadPath}"
                : $"https://{AzureStorageAccountName}.{AzureStorageEnvironment}/{AzureStorageContainer}/{uploadPath}";
        }
        return url;
    }
