...
public partial class ImageHistoryForm : Form
{
    ...
    private void ApplyFilter()
    {
        ...
        List<HistoryItem> filteredHistoryItems = new();
        ...
        ImageListViewItem[] ilvItems = [.. filteredHistoryItems.Select(hi => new ImageListViewItem(hi.FilePath) { Tag = hi })];
    ...
    {
        using (ImageHistorySettingsForm form = new(Settings))
        {
            form.ShowDialog();
        }
