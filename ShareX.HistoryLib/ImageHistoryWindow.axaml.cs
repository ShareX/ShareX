...
public partial class ImageHistoryWindow : Window
{
    ...
    {
        double cardWidth = Math.Max(52, _settings.ThumbnailSize.Width + 20 + 12);
        int columns = Math.Max(1, (int)Math.Floor(Math.Max(1, ThumbnailRows.Bounds.Width - 12) / cardWidth));
