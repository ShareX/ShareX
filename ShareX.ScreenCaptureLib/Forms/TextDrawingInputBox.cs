...
internal partial class TextDrawingInputBox : Form
{
    ...
    public TextDrawingInputBox(string text, TextDrawingOptions options, bool supportGradient, ColorPickerOptions colorPickerOptions)
    {
        ...
        cbFonts.SelectedItem = cbFonts.Items.Contains(Options.Font) ? Options.Font : (object)AnnotationOptions.DefaultFont;
    ...
    {
        lblTip.Text = Options.EnterKeyNewLine ? Resources.NewLineEnterOKCtrlEnter : Resources.NewLineCtrlEnterOKEnter;
    }
