...
using ShareX.ScreenCaptureLib.ScreenRecording;
...
public partial class FFmpegOptionsForm : Form
{
    ...
    public FFmpegOptionsForm(ScreenRecordingOptions options)
    {
        ...
        cbVideoCodec.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegVideoCodec>());
        cbAudioCodec.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegAudioCodec>());
        cbx264Preset.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegPreset>());
        cbGIFStatsMode.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegPaletteGenStatsMode>());
        cbNVENCPreset.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegNVENCPreset>());
        cbNVENCTune.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegNVENCTune>());
        cbGIFDither.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegPaletteUseDither>());
        cbAMFUsage.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegAMFUsage>());
        cbAMFQuality.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegAMFQuality>());
        cbQSVPreset.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetEnumDescriptions<FFmpegQSVPreset>());

        cbAACBitrate.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.Range(64, 320, 32).Cast<object>().ToArray());
        cbOpusBitrate.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.Range(32, 512, 32).Cast<object>().ToArray());
        cbVorbisQuality.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.Range(0, 10).Cast<object>().ToArray());
        cbMP3Quality.Items.AddRange(ShareX.HelpersLib.Helpers.Helpers.Range(9, 0).Cast<object>().ToArray());
    }
    ...
    private async Task LoadSettings()
    {
        ...
        cbAACBitrate.SelectedIndex = indexAACBitrate > -1 ? indexAACBitrate : cbAACBitrate.Items.IndexOf(128);

        // Opus
        int indexOpusBitrate = cbOpusBitrate.Items.IndexOf(Options.FFmpeg.Opus_Bitrate);

        cbOpusBitrate.SelectedIndex = indexOpusBitrate > -1 ? indexOpusBitrate : cbOpusBitrate.Items.IndexOf(128);

        // Vorbis
        int indexVorbisQuality = cbVorbisQuality.Items.IndexOf(Options.FFmpeg.Vorbis_QScale);

        cbVorbisQuality.SelectedIndex = indexVorbisQuality > -1 ? indexVorbisQuality : cbVorbisQuality.Items.IndexOf(3);

        // MP3
        int indexMP3Quality = cbMP3Quality.Items.IndexOf(Options.FFmpeg.MP3_QScale);

        cbMP3Quality.SelectedIndex = indexMP3Quality > -1 ? indexMP3Quality : cbMP3Quality.Items.IndexOf(4);
    ...
    private async Task RefreshSourcesAsync(bool selectDevices = false)
    {
        ...
        await Task.Run(() =>
        {
            ...
            {
                using FFmpegCLIManager ffmpeg = new(Options.FFmpeg.FFmpegPath);
        ...
        if (!IsDisposed)
        {
            ...
            if (ShareX.HelpersLib.Helpers.Helpers.IsWindows10OrGreater())
            {
