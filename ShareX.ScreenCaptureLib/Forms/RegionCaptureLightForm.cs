...
public sealed class RegionCaptureLightForm : Form
{
    ...
    public Rectangle ScreenRectangle0Based => new(0, 0, ScreenRectangle.Width, ScreenRectangle.Height);
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public Rectangle SelectionRectangle { get; private set; }
    public Rectangle SelectionRectangle0Based => new(SelectionRectangle.X - ScreenRectangle.X, SelectionRectangle.Y - ScreenRectangle.Y,
    ...
    public Bitmap GetAreaImage()
    {
        ...
        return rect.Width > 0 && rect.Height > 0
            ? rect.X == 0 && rect.Y == 0 && rect.Width == backgroundImage.Width && rect.Height == backgroundImage.Height
                ? (Bitmap)backgroundImage.Clone()
                : ImageHelpers.CropBitmap(backgroundImage, rect)
            : null;
    }
