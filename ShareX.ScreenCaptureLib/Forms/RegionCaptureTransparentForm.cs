...
public sealed class RegionCaptureTransparentForm : LayeredForm
{
    ...
    public Rectangle SelectionRectangle0Based => new(SelectionRectangle.X - ScreenRectangle.X,
    ...
    private Rectangle PreviousSelectionRectangle0Based => new(PreviousSelectionRectangle.X - ScreenRectangle.X,
    ...
    public Bitmap GetAreaImage(Screenshot screenshot)
    {
        ...
        return rect.Width > 0 && rect.Height > 0 ? screenshot.CaptureRectangle(SelectionRectangle) : null;
    }
