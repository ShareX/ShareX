...
public partial class ScreenRecordForm : Form
{
    ...
    public ScreenRecordForm(Rectangle regionRectangle)
    {
        ...
        Region region = new(ClientRectangle);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        using (Pen pen2 = new(borderColor) { DashPattern = new float[] { 5, 5 }, DashOffset = 5 })
        {
    ...
    private void lblTimer_MouseMove(object sender, MouseEventArgs e)
    {
        if (dragging)
        {
            Point newLocation = new(Location.X + e.X - initialLocation.X, Location.Y + e.Y - initialLocation.Y);
