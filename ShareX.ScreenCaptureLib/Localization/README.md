...
All 283 keys are available in all 27 supported cultures. Existing WinForms views retain their form-specific `.resx` catalogs, while `Properties/Resources.resx` is limited to bitmap and cursor assets.
