...
using ShareX.ScreenCaptureLib.Animations;
using ShareX.ScreenCaptureLib.Forms;
using ShareX.ScreenCaptureLib.Properties;
using ShareX.ScreenCaptureLib.Shapes.Drawing;
...
internal partial class ShapeManager
{
    ...
    internal TextAnimation MenuTextAnimation = new()
    {
    ...
    internal void CreateToolbar()
    {
        ...
        if (Form.IsEditorMode)
        {
            ...
            ToolStripButton tsbCompleteEdit = new();

            tsbCompleteEdit.Text = Form.Mode == RegionCaptureMode.Editor
                ? Resources.ShapeManager_CreateToolbar_RunAfterCaptureTasks
                : Resources.ShapeManager_CreateToolbar_ApplyChangesContinueTaskEnter;
            ...
            {
                ToolStripButton tsbContinueTask = new(Resources.ShapeManager_CreateToolbar_ContinueTaskSpaceOrRightClick);
                ...
                ToolStripButton tsbCancelTask = new(Resources.ShapeManager_CreateToolbar_CancelTaskEsc);
            ...
            ToolStripButton tsbSaveImageAs = new(Resources.ShapeManager_CreateToolbar_SaveImageAs);
            ...
            ToolStripButton tsbCopyImage = new(Resources.ShapeManager_CreateToolbar_CopyImageToClipboard);
            ...
            ToolStripButton tsbUploadImage = new(Resources.ShapeManager_CreateToolbar_UploadImage);
            ...
            ToolStripButton tsbPrintImage = new(Resources.ShapeManager_CreateToolbar_PrintImage);
        ...
        } else if (ShareX.HelpersLib.Helpers.Helpers.IsTabletMode())
        {
            ToolStripButton tsbClose = new(Resources.CloseEsc);
        ...
        foreach (ShapeType shapeType in ShareX.HelpersLib.Helpers.Helpers.GetEnums<ShapeType>())
        {
            if (Form.IsEditorMode)
            {
            ...
            ToolStripButton tsbShapeType = new(shapeType.GetLocalizedDescription());
            ...
            switch (shapeType)
            {
                ...
                case ShapeType.DrawingSticker:
                    img = RandomFast.Next(1, 10) == 1 ? Resources.smiley_cool : (Image)Resources.smiley_yell;
                    break;
        ...
        tsbBorderColor.Click += (sender, e) =>
        {
            ...
            Color borderColor = shapeType == ShapeType.DrawingTextBackground || shapeType == ShapeType.DrawingSpeechBalloon
                ? AnnotationOptions.TextBorderColor
                : shapeType == ShapeType.DrawingTextOutline
                    ? AnnotationOptions.TextOutlineBorderColor
                    : shapeType == ShapeType.DrawingStep ? AnnotationOptions.StepBorderColor : AnnotationOptions.BorderColor;
        ...
        tsbFillColor.Click += (sender, e) =>
        {
            ...
            Color fillColor = shapeType == ShapeType.DrawingTextBackground || shapeType == ShapeType.DrawingSpeechBalloon
                ? AnnotationOptions.TextFillColor
                : shapeType == ShapeType.DrawingStep ? AnnotationOptions.StepFillColor : AnnotationOptions.FillColor;
        ...
        tscbBorderStyle.Content.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<BorderStyle>());
        ...
        tscbImageInterpolationMode.Content.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<ImageInterpolationMode>());
        ...
        CursorConverter cursorConverter = new();
        foreach (Cursor cursor in ShareX.HelpersLib.Helpers.Helpers.CursorList)
        {
        ...
        tscbArrowHeadDirection.Content.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<ArrowHeadDirection>());
        ...
        tscbStepType.Content.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<StepType>());
        ...
        tscbCutOutEffectType.Content.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<CutOutEffectType>());
        ...
        ToolStripDropDownButton tsddbEdit = new(Resources.ShapeManager_CreateToolbar_Edit);
        ...
        ToolStripMenuItem tsmiPaste = new(Resources.ShapeManager_CreateToolbar_PasteImageText);
        ...
        if (Form.IsEditorMode)
        {
            ...
            ToolStripDropDownButton tsddbImage = new(Resources.ShapeManager_CreateToolbar_Image);
            ...
            ToolStripMenuItem tsmiNewImage = new(Resources.ShapeManager_CreateToolbar_NewImage);
            tsmiNewImage.Image = Resources.image_empty;
            tsmiNewImage.Click += (sender, e) => NewImage();
            tsddbImage.DropDownItems.Add(tsmiNewImage);

            ToolStripMenuItem tsmiOpenImage = new(Resources.ShapeManager_CreateToolbar_OpenImageFile);
            ...
            ToolStripMenuItem tsmiInsertImageFile = new(Resources.ShapeManager_CreateToolbar_InsertImageFile);
            ...
            ToolStripMenuItem tsmiInsertImageFromScreen = new(Resources.ShapeManager_CreateToolbar_InsertImageFromScreen);
            ...
            ToolStripMenuItem tsmiImageSize = new(Resources.ShapeManager_CreateToolbar_ImageSize);
            ...
            ToolStripMenuItem tsmiCanvasSize = new(Resources.ShapeManager_CreateToolbar_CanvasSize);
            ...
            ToolStripMenuItem tsmiCropImage = new(Resources.ShapeManager_CreateToolbar_CropImage);
            ...
            ToolStripMenuItem tsmiAutoCropImage = new(Resources.ShapeManager_CreateToolbar_AutoCropImage);
            ...
            ToolStripMenuItem tsmiRotate90Clockwise = new(Resources.ShapeManager_CreateToolbar_Rotate90Clockwise);
            ...
            ToolStripMenuItem tsmiRotate90CounterClockwise = new(Resources.ShapeManager_CreateToolbar_Rotate90CounterClockwise);
            ...
            ToolStripMenuItem tsmiRotate180 = new(Resources.ShapeManager_CreateToolbar_Rotate180);
            ...
            ToolStripMenuItem tsmiFlipHorizontal = new(Resources.ShapeManager_CreateToolbar_FlipHorizontal);
            ...
            ToolStripMenuItem tsmiFlipVertical = new(Resources.ShapeManager_CreateToolbar_FlipVertical);
            ...
            ToolStripMenuItem tsmiAddImageEffects = new(Resources.ImageEffects);
        ...
        if (!Form.IsEditorMode)
        {
            ...
            ToolStripDropDownButton tsddbCapture = new(Resources.ShapeManager_CreateContextMenu_Capture);
            ...
            {
                ToolStripMenuItem tsmiLastRegionCapture = new(Resources.ShapeManager_CreateToolbar_LastRegion);
            ...
            ToolStripMenuItem tsmiFullscreenCapture = new(Resources.ShapeManager_CreateContextMenu_Capture_fullscreen);
            ...
            ToolStripMenuItem tsmiActiveMonitorCapture = new(Resources.ShapeManager_CreateContextMenu_Capture_active_monitor);
            ...
            ToolStripMenuItem tsmiMonitorCapture = new(Resources.ShapeManager_CreateContextMenu_Capture_monitor);
            ...
            for (int i = 0; i < screens.Length; i++)
            {
                ...
                ToolStripMenuItem tsmi = new($"{screen.Bounds.Width}x{screen.Bounds.Height}");
        ...
        ToolStripDropDownButton tsddbOptions = new(Resources.ShapeManager_CreateContextMenu_Options);
        ...
        if (Form.IsEditorMode)
        {
            ToolStripLabeledComboBox tscbImageEditorStartMode = new(Resources.ShapeManager_CreateToolbar_EditorStartMode);
            tscbImageEditorStartMode.Content.AddRange(ShareX.HelpersLib.Helpers.Helpers.GetLocalizedEnumDescriptions<ImageEditorStartMode>());
            ...
            ToolStripMenuItem tsmiZoomToFitOnOpen = new(Resources.ShapeManager_CreateToolbar_ZoomToFitOnOpen);
            ...
            ToolStripMenuItem tsmiEditorAutoCopyImage = new(Resources.AutoCopyImageToClipboard);
            ...
            ToolStripMenuItem tsmiAutoCloseEditorOnTask = new(Resources.ShapeManager_CreateToolbar_AutoCloseEditorOnTask);
        ...
        ToolStripMenuItem tsmiShowInfo = new(Resources.ShapeManager_CreateContextMenu_Show_position_and_size_info);
        ...
        ToolStripMenuItem tsmiUseSquareMagnifier = new(Resources.ShapeManager_CreateContextMenu_Square_shape_magnifier);
        ...
        ToolStripLabeledNumericUpDown tslnudMagnifierPixelSize = new(Resources.ShapeManager_CreateContextMenu_Magnifier_pixel_size_);
        ...
        ToolStripMenuItem tsmiShowCrosshair = new(Resources.ShapeManager_CreateContextMenu_Show_screen_wide_crosshair);
        ...
        ToolStripMenuItem tsmiUseLightResizeNodes = new(Resources.LightResizeNodes);
        ...
        ToolStripMenuItem tsmiEnableAnimations = new(Resources.ShapeManager_CreateContextMenu_EnableAnimations);
        ...
        if (!Form.IsEditorMode)
        {
            ToolStripMenuItem tsmiFixedSize = new(Resources.ShapeManager_CreateContextMenu_Fixed_size_region_mode);
            ...
            ToolStripDoubleLabeledNumericUpDown tslnudFixedSize = new(Resources.ShapeManager_CreateContextMenu_Width_,
        ...
        ToolStripMenuItem tsmiShowFPS = new(Resources.ShapeManager_CreateContextMenu_Show_FPS);
        ...
        ToolStripLabeledNumericUpDown tslnudFPSLimit = new(Resources.FPSLimit);
        ...
        ToolStripMenuItem tsmiSwitchToDrawingToolAfterSelection = new(Resources.ShapeManager_CreateContextMenu_SwitchToDrawingToolAfterSelection);
        ...
        ToolStripMenuItem tsmiSwitchToSelectionToolAfterDrawing = new(Resources.ShapeManager_CreateContextMenu_SwitchToSelectionToolAfterDrawing);
        ...
        ToolStripLabeledNumericUpDown tslnudMenuIconSize = new(Resources.MenuIconSize);
        ...
        if (!Form.IsEditorMode)
        {
            ToolStripMenuItem tsmiLockMenu = new(Resources.LockMenu);
            ...
            ToolStripMenuItem tsmiRememberMenuState = new(Resources.ShapeManager_CreateContextMenu_RememberMenuState);
        ...
        ToolStripMenuItem tsmiKeybinds = new(Resources.OpenKeybindsPage);
    ...
    {
        Rectangle rectScreen = Form.IsFullscreen ? CaptureHelpers.GetActiveScreenBounds() : Form.RectangleToScreen(Form.ClientArea);
        menuForm.Location = !Form.IsEditorMode && Options.RememberMenuState && rectScreen.Contains(Options.MenuPosition)
            ? Options.MenuPosition
            : tsMain.Width < rectScreen.Width
                ? new Point(rectScreen.X + (rectScreen.Width / 2) - (tsMain.Width / 2), rectScreen.Y)
                : rectScreen.Location;
    }
    ...
    private void UpdateMenu()
    {
        ...
        int borderSize = shapeType == ShapeType.DrawingTextBackground || shapeType == ShapeType.DrawingSpeechBalloon
            ? AnnotationOptions.TextBorderSize
            : shapeType == ShapeType.DrawingTextOutline
                ? AnnotationOptions.TextOutlineBorderSize
                : shapeType == ShapeType.DrawingStep ? AnnotationOptions.StepBorderSize : AnnotationOptions.BorderSize;
    ...
    {
        return tscbCursorTypes.Content.SelectedIndex > -1
            ? ShareX.HelpersLib.Helpers.Helpers.CursorList[tscbCursorTypes.Content.SelectedIndex]
            : Cursors.Default;
    }
