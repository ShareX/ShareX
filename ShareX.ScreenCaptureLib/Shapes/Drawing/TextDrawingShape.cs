...
public class TextDrawingShape : RectangleDrawingShape
{
    ...
    protected void DrawText(Graphics g, string text, Color textColor, TextDrawingOptions options, RectangleF rect)
    {
        ...
        {
            using Font font = new(options.Font, options.Size, options.Style);
            using Brush textBrush = new SolidBrush(textColor);
            using StringFormat sf = new() { Alignment = options.AlignmentHorizontal, LineAlignment = options.AlignmentVertical };
    ...
    private bool ShowTextInputBox()
    {
        ...
        using (TextDrawingInputBox inputBox = new(Text, TextOptions, SupportGradient, Manager.Options.ColorPickerOptions))
        {
    ...
    public void AutoSize(bool center)
    {
        ...
        {
            using Font font = new(TextOptions.Font, TextOptions.Size, TextOptions.Style);
        ...
        PointF location = center ? new PointF(Rectangle.X - size.Width / 2, Rectangle.Y - size.Height / 2) : Rectangle.Location;
