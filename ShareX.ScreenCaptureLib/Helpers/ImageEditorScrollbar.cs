...
internal class ImageEditorScrollbar : ImageEditorControl
{
    ...
    public void Update()
    {
        if (AutoHide)
        {
            ...
            bool isScrollbarNeeded = Orientation == Orientation.Horizontal
                ? imageRectangle.Left < form.ClientArea.Left ||
                    imageRectangle.Right * form.ZoomFactor > form.ClientArea.Right
                : imageRectangle.Top < form.ClientArea.Top ||
    ...
    {
        Color thumbColor = IsDragging || form.ShapeManager.IsPanning || IsCursorHover ? ActiveThumbColor : ThumbColor;
