...
Supported cultures: `ar-YE`, `cs-CZ`, `de`, `es`, `es-MX`, `fa-IR`, `fr`, `he-IL`, `hi-IN`, `hu`, `id-ID`, `it-IT`, `ja-JP`, `ko-KR`, `nl-NL`, `pl`, `pt-BR`, `pt-PT`, `ro`, `ru`, `sv-SE`, `tr`, `uk`, `vi-VN`, `zh-CN`, and `zh-TW`.
