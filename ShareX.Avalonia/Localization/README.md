...
The repository-level `Scripts/ValidateTranslations.ps1` checks the supported-culture inventory, entry counts, key parity, non-empty values, format placeholders, UTF-8 and CRLF formatting, generated designers, source references, and remaining literal Avalonia UI text across every localized project.
