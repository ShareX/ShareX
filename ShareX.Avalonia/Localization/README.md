...
All 9 keys are translated in all 25 supported cultures. Theme identifiers, asset URIs, font names, format tokens such as `$HEX`, and framework known-color names are stable technical data and are intentionally excluded.
