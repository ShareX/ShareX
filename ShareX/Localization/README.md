...
- localized values do not match the English source after case, spacing, and punctuation normalization unless the resource/culture pair is explicitly reviewed in `Scripts/TranslationEnglishAllowlist.txt`;
