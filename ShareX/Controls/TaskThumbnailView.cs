...
public partial class TaskThumbnailView : UserControl
{
    ...
    public TaskThumbnailPanel SelectedPanel
    {
        get
        {
            return SelectedPanels.Count > 0 ? SelectedPanels[SelectedPanels.Count - 1] : null;
        }
    }
    ...
    private Size thumbnailSize = new(200, 150);
    ...
    {
        BackColor = ShareXResources.UseCustomTheme ? ShareXResources.Theme.BackgroundColor : SystemColors.Window;
    ...
    {
        TaskThumbnailPanel panel = new(task);
        panel.ThumbnailSize = ThumbnailSize;
        panel.ClickAction = ClickAction;
        panel.TitleVisible = TitleVisible;
        panel.TitleLocation = TitleLocation;
