...
public class QuickTaskMenu
{
    ...
    public void ShowMenu()
    {
        ...
        ToolStripMenuItem tsmiContinue = new(Resources.QuickTaskMenu_ShowMenu_Continue);
        ...
        if (Program.Settings != null && Program.Settings.QuickTaskPresets != null && Program.Settings.QuickTaskPresets.Count > 0)
        {
            foreach (QuickTaskInfo taskInfo in Program.Settings.QuickTaskPresets)
            {
                if (taskInfo.IsValid)
                {
                    ToolStripMenuItem tsmi = new() { Text = taskInfo.ToString().Replace("&", "&&"), Tag = taskInfo };
        ...
        ToolStripMenuItem tsmiEdit = new(Resources.QuickTaskMenu_ShowMenu_Edit_this_menu___);
        ...
        ToolStripMenuItem tsmiCancel = new(Resources.QuickTaskMenu_ShowMenu_Cancel);
