...
public partial class BorderlessWindowForm : Form
{
    ...
    private void UpdateWindowListMenu()
    {
        ...
        WindowsList windowsList = new(Handle);
        ...
        if (windows != null && windows.Count > 0)
        {
            ...
            foreach (WindowInfo window in windows)
            {
                try
                {
                    ...
                    ToolStripMenuItem tsmi = new(shortTitle);
    ...
    private void btnMakeWindowBorderless_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Settings.WindowTitle = Settings.RememberWindowTitle ? windowTitle : "";
    ...
    {
        using BorderlessWindowSettingsForm form = new(Settings);
        form.ShowDialog();
    }
