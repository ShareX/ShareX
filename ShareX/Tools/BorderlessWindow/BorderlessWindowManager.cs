...
{
    private static readonly ConcurrentDictionary<IntPtr, BorderlessWindowInfo> borderlessWindowList = new();
    ...
    private static void MakeWindowBorderless(IntPtr hWnd, bool useWorkingArea = false)
    {
        ...
        BorderlessWindowInfo borderlessWindowInfo = new(windowInfo);
        ...
        Rectangle rect = useWorkingArea ? screen.WorkingArea : screen.Bounds;
