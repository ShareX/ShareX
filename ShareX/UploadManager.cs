...
public static class UploadManager
{
    ...
    private static bool IsUploadConfirmed(int length)
    {
        ...
        {
            using MyMessageBox msgbox = new(string.Format(Resources.UploadManager_IsUploadConfirmed_Are_you_sure_you_want_to_upload__0__files_, length),
    ...
    public static void UploadFile(TaskSettings taskSettings = null)
    {
        ...
        ofd.InitialDirectory = !string.IsNullOrEmpty(Program.Settings.FileUploadDefaultDirectory) && Directory.Exists(Program.Settings.FileUploadDefaultDirectory)
            ? Program.Settings.FileUploadDefaultDirectory
    ...
    {
        using FolderSelectDialog folderDialog = new();
        folderDialog.Title = "ShareX - " + Resources.UploadManager_UploadFolder_Folder_upload;

        folderDialog.InitialDirectory = !string.IsNullOrEmpty(Program.Settings.FileUploadDefaultDirectory) && Directory.Exists(Program.Settings.FileUploadDefaultDirectory)
            ? Program.Settings.FileUploadDefaultDirectory
            : Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
    ...
    public static void ClipboardUpload(TaskSettings taskSettings = null)
    {
        ...
        try
        {
            ...
            {
                Bitmap image = HelpersOptions.UseAlternativeClipboardGetImage ? ClipboardHelpers.GetImageAlternative2() : (Bitmap)Clipboard.GetImage();
    ...
    public static void ClipboardUploadWithContentViewer(TaskSettings taskSettings = null)
    {
        ...
        using ClipboardUploadForm clipboardUploadForm = new(taskSettings);
    ...
    public static void ClipboardUploadMainWindow(TaskSettings taskSettings = null)
    {
        ...
        {
            using ClipboardUploadForm clipboardUploadForm = new(taskSettings, true);
            clipboardUploadForm.ShowDialog();
    ...
    public static void RunImageTask(TaskMetadata metadata, TaskSettings taskSettings, bool skipQuickTaskMenu = false, bool skipAfterCaptureWindow = false)
    {
        ...
        if (metadata != null && metadata.Image != null && taskSettings != null)
        {
            ...
            {
                QuickTaskMenu quickTaskMenu = new();
